...
<html lang="en">
      ...
      <div class="block-30 block-30-sm item" style="background-image: url('images/banner.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
              <h2 class="heading mb-5">Find Out The Details Of The Events</h2>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="featured-section overlay-color-2" style="background-image: url('images/a2.jpg');">
      ...
      <div class="row">
        ...
        <div class="col-md-6 pl-md-5">
          ...
          <div class="form-volunteer">
			...
			<h3>Searching the details of the events</h3><br>

            <form action="searcheventsaction.php" id="form" method="GET">
              <div class="form-group">
                <!-- <label for="name">Name</label> -->
                <input type="text" class="form-control py-2" name="searchevents" placeholder="Searching for ...">
              </div>
              <div class="form-group">
                <input type="submit" class="btn btn-white px-5 py-2" value="Search">
              </div>
            </form>
          </div>
        </div>
